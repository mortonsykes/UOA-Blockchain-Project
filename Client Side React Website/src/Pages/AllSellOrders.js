  ...
  constructor(props) {
    ...
    this.state = {
        columnDefs: [
            ...
            {headerName: "Seller", field: "seller.organisationID", valueFormatter: removeClassStringFromDataSimple},
...
//Get Data
    fetch('/api/SlotTokenSellOrder?filter={"where": {"status": "Pending"},"include":"resolve"}')
...
render() {
    return (
      ...
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 className="h2">All Sell Orders</h1>
