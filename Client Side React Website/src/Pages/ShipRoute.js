...
class ShipRoute extends Component {
  constructor(props) {
    ...
    this.state = {
        columnDefs: [
            {headerName: "RouteID", field: "routeID", checkboxSelection: true},
            {headerName: "Route Name", field: "routeName"},
            {headerName: "Ports", field: "ports", cellStyle: {'white-space': 'pre-line'}, autoHeight: true}
    ...
    return (
      <div style={{ width: "100%", height: "100%", minheight: "100px" }}>
        ...
        <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 className="h2">Shipping Routes</h1>
