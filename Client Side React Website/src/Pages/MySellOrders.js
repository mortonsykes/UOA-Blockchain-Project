...
class MySellOrders extends Component {
  constructor(props) {
    super(props);

    this.state = {
        columnDefs: [
            {headerName: "ID", field: "slotTokenSellOrderID", checkboxSelection: true},
            {headerName: "Voyage", field: "voyage.voyageID"},
            {headerName: "Quantity", field: "containerSlotQuantity_TEU"},
            {headerName: "Sell Price", field: "sellPriceLimit", valueFormatter: AddCurrencySymbol},
            ...
            {headerName: "Voyage", field: "sellerToken.voyageSlot_TokenID", hide: true},
    ...
    this.editSellOrder = this.editSellOrder.bind(this);
  ...
  editSellOrder() {
    debugger;
    fetch('/api/VoyageToken_EditSellOrder', {
      method: 'post',
      headers: {
      ...
      body: JSON.stringify(
        {
          $class: 'org.example.shipping.VoyageToken_EditSellOrder',
          sellOrder: 'resource:org.example.shipping.SlotTokenSellOrder#' + this.state.modal_SlotTokenSellOrderID,
    ...
    fetch('/api/SlotTokenSellOrder?filter={"include":"resolve"}')
  ...
  deleteSellOrder() {
    debugger;
    fetch('/api/VoyageToken_PlaceSellOrder/'+ this.state.modal_SlotTokenSellOrderID, {
      method: 'delete',
      headers: {
        'Accept': 'application/json, text/plain, */*',
        'Content-Type': 'application/json'
...
//Get Data
    ...
    // componentDidMount() {
    //fetch('/api/SlotTokenSellOrder?filter={"where": {"seller": "Quote"},"include":"resolve"}')
    //   }
...
render() {
    return (
      ...
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h1 className="h2">My Carrier's Token Sell Orders</h1>
          <div className="btn-toolbar mb-2 mb-md-0">
            ...
            <button type="button" class="btn btn-primary" onClick={this.onButtonClick}>&nbsp; Edit Sell Order &nbsp;</button>   
            <button style={{marginLeft: '2rem'}} type="button" class="btn btn-primary" onClick={this.onButtonClickDelete}>&nbsp; Delete Sell Order &nbsp;</button>        

        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          <ModalHeader toggle={this.toggle}><h3>Edit Sell Order</h3></ModalHeader>
          <ModalBody>
            <pre>
              <b>Sell Order ID: </b>{this.state.modal_SlotTokenSellOrderID}
              <br/>
          ...
          <ModalFooter>
            <Button color="primary" onClick={this.editSellOrder}>Confirm</Button>{' '}
        ...
        <Modal isOpen={this.state.modal2} toggle={this.toggle2} className={this.props.className}>
          ...
          <ModalFooter>
            <Button color="primary" onClick={this.deleteSellOrder}>Confirm</Button>{' '}
  ...
  onButtonClick = e => {
    ...
    if (selectedNodes.length > 0){
      ...
      this.setState({modal_SlotTokenSellOrderID: selectedData[0].slotTokenSellOrderID.toString(),
        ...
        modal_VoyageSlot_TokenID: selectedData[0].sellerToken.voyageSlot_TokenID.toString()  
      });  
      this.toggle();
    }else{
